...
static constexpr unsigned int DEFAULT_INCREMENTAL_RELAY_FEE{500};
...
static constexpr unsigned int DUST_RELAY_TX_FEE{1500};
/** Default for -minrelaytxfee, minimum relay fee for transactions */
static constexpr unsigned int DEFAULT_MIN_RELAY_TX_FEE{500};
