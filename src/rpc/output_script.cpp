...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        "validateaddress",
        "Return information about the given quanta address.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The quanta address to validate"},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::BOOL, "isvalid", "If the address is valid or not"},
                {RPCResult::Type::STR, "address", /*optional=*/true, "The quanta address validated"},
