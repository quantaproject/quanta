...
static int AppInitUtil(ArgsManager& args, int argc, char* argv[])
{
    ...
    if (HelpRequested(args) || args.GetBoolArg("-version", false)) {
        ...
        std::string strUsage = CLIENT_NAME " quanta-util utility version " + FormatFullVersion() + "\n";
        ...
        if (args.GetBoolArg("-version", false)) {
            ...
            strUsage += "\n"
                ...
                "\n"
                "Usage:  quanta-util [options] [command]\n"
                "or:     quanta-util [options] grind <hex-block-header>\n";
            strUsage += "\n" + args.GetHelpMessage();
        }
