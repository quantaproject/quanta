...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << "0488ee17b66ce2830f54a9e09186debed480e880121ec399a9343eb7c678f4882606c6505d1f54bf89f5b52e1ff1e1fe7416f044aa86c4a84ef3d527b66c2e02e1"_hex << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 1000; // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.BIP66Height = 1000; // 00000000000000000379eaa19dce8c9b722d46ae6a57c2f1a988119488b50931
        consensus.CSVHeight = 1000; // 000000000000000004a1b34462cb8aeebd5799177f7a29cf28f2d1961716b5b5
        consensus.SegwitHeight = 21600; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 21600 + 2016; // segwit activation height + miner confirmation window
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 1746057600; // April 24th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 1782595200; // August 11th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 2016; // Approximately November 12th, 2021
        ...
        genesis = CreateGenesisBlock(1746057600, 1008563166, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"000000002c96f12ce513bde4d6ab6164494cb6a2763a93c6d134481a5ea88d3a"});
        assert(genesis.hashMerkleRoot == uint256{"fb2984a48f1b0c3d766752d4971542fbce2c0a1a5d089a1223eece79e8936de9"});
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x93, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x93, 0xAD, 0xE4};
